...
require (
	...
	github.com/buxizhizhoum/inflection v1.0.4 // indirect
	...
	github.com/rootlyhq/terraform-provider-rootly v1.5.0 // indirect
...
require (
	...
	github.com/rootlyhq/terraform-provider-rootly/v2 v2.8.0
