...
func (g* IncidentTypeGenerator) InitResources() error {
	...
	for {
		resources, err := func(page_size, page_num int) ([]interface{}, error) {
			...
			return client.ListIncidentTypes(params)
		}(page_size, page_num)
      ...
      tf_resource := g.createIncidentTypeResource(resource)
...
func (g *IncidentTypeGenerator) createIncidentTypeResource(provider_resource interface{}) terraformutils.Resource {
	x, _ := provider_resource.(*client.IncidentType)
