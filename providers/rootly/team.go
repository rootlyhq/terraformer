...
func (g* TeamGenerator) InitResources() error {
	...
	for {
      ...
      tf_resource := g.createTeamResource(resource)
...
func (g *TeamGenerator) createTeamResource(provider_resource interface{}) terraformutils.Resource {
	x, _ := provider_resource.(*client.Team)
